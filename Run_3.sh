...
#python -u main_Train_mainModel.py --config exp/SampNumber_Etapa_3_DM_SA_DN_silveira3.json
python -u main_Train_mainModel.py --folder ../NN_Results/NN_Trainning_19_September_2026_09-23AM_Job2958/
