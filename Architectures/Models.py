...
class MS_Net_Extended(nn.Module):
    def __init__(self, bin_input=True):
        super().__init__() 
        
        self.bin_input = bin_input
        
        self.x_model    = MS_Net(nc_out = 1, num_features = 1)
        
        self.y_model    = MS_Net(nc_out = 1, num_features = 1)
        
        self.z_model    = MS_Net(nc_out = 1, num_features = 1)
        
        self.p_model    = MS_Net(nc_out = 1, num_features = 1)
        
        self.concat     = self.Concat_Block()
        
        self.main_model = MS_Net(nc_out = 4, num_features = 4)
