...
output_results_dir = "./Model_Error_Outputs"
...
if component == 0:
    ...
    danny_model_base3 = Extended_DannyKo()
    model_z_3 = danny_model_base3.z_model
    model_z_3.load_state_dict(torch.load("./Trained_Models/NN_Trainning_26_August_2026_06-21PM_Job27380/model_LowerValidationLoss.pth", map_location=torch.device(device), weights_only=True))
    model_z_3.bin_input = True
    models_dict["Ko et al (Etapa 3)"] = model_z_3
    ...
    danny_model_base3 = Extended_DannyKo()
    model_z_3 = danny_model_base3.z_model
    model_z_3.load_state_dict(torch.load("./Trained_Models/NN_Trainning_26_August_2026_03-47PM_Job27377/model_LowerValidationLoss.pth", map_location=torch.device(device), weights_only=True))
    model_z_3.bin_input = True
    models_dict["Ko et al (Etapa 3)"] = model_z_3
