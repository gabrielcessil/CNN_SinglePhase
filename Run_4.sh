...
#python -u main_Train_mainModel.py --config exp/SampNumber_Etapa_3_DM_SA_DN_silveira4.json
python -u main_Train_mainModel.py --folder ../NN_Results/NN_Trainning_18_September_2026_07-20PM_Job29580/
