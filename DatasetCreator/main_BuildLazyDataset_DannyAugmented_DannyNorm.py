    ...
    with h5py.File(output_path, "w") as f:
        ...
        for sample_name in sample_dirs:
            ...
            try:
                ...
                # 2. Velocity and Pressure Normalization
                ...
                # 3. Generate random augmentation parameters for this sample
                shift_val  = D // shift_range  # D=120
                ...
                # 4. Apply Augmentations Loop
                for j in range(aug_iter):
                    
                    # Apply Shift (shift_range=[shift_y, shift_x] implicitly based on logic)
                    ...
                    # Apply Flip Axis 0 (X direction) -> maps to axis 2 in Danny's function
                    ...
                    # Apply Flip Axis 1 (Y direction) -> maps to axis 1 in Danny's function
                    ...
                    # 5. Geometry-based calculations (EDT and Mask) on augmented volume
