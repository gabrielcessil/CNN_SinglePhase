...
infos = {
    ...
    "../../NN_Datasets/Valid_Danny_SphPore_DAug_SNorm.h5",
    ...
    # "../../NN_Datasets/Train_Danny_SphPore_DAug_SNorm.h5",
}
        ...
        for sample_name in sample_dirs:
            ...
            try:
                ...
                for j in range(aug_iter):
                    ...
                    # Apply Flip Axis 0 (X direction) -> maps to axis 2
                    ...
                    # Apply Flip Axis 1 (Y direction) -> maps to axis 1
