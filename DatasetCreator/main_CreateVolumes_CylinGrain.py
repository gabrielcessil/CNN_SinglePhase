...
if dataset_type =='test':
    output_root = "../../Simulations/Test_CylinGrain_120_120_120"
    N_SAMPLES       = 2

if dataset_type =='valid':
    output_root = "../../Simulations/Valid_CylinGrain_120_120_120"
    N_SAMPLES       = 1 
    
if dataset_type =='train':
    output_root = "../../Simulations/Train_CylinGrain_120_120_120"
    N_SAMPLES       = 10 
...
for SPHERES_FILL, MEAN_RADIUS in config_pairs:    # Porosities large enough so that spheres touch
    ...
    for n in range(N_SAMPLES*10):
        ...
        if remove_isolated:
            ...
            outlets[-1, :, :] = 1 
            vol = ps.filters.trim_nonpercolating_paths(vol, inlets=inlets, outlets=outlets)
