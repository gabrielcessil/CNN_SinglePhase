...
class ParaViewRenderer:
    ...
    def render_file(self, target_path, pred_path, output_filename, epoch, override_camera_pos, override_view_up):
        ...
        for disp in self.wireframe_displays + solid_displays + [disp_stream_t, disp_vol_t, disp_stream_p, disp_vol_p, disp_z_arrow]:
            try: Delete(disp)
            except: pass
